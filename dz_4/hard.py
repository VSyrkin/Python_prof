...
person3 = {'card': 1, 'pin': 1, 'money': 100}
        ...
        while True:
            try:
                ...
                if count >= 0:
                    ...
                    print('Сумма введена неверно, вы ввели отрицательное число')
            except ValueError:
                print('Сумма введена неверно, введите число')
...
def start():
    while True:
        try:
            ...
            print('Неверный формат номера карты и/или пин кода')
